...
#initializeing
algo=cv2.createBackgroundSubtractorMOG2()#this fun or algo removes the background which shold not be detected
...
while True:
    ...
    cv2.putText(frame,"vehicle counter :"+str(counter),(400,70),cv2.FONT_HERSHEY_SIMPLEX,2,(255,0,0),5)
